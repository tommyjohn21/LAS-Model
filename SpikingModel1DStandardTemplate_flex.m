...
T_refractory = gen_param(5/2,0,n,1);% ms, the duration of AP + absolutely refractory period 
...
dt_AP = 0.5/2; % length of action potential, ms
...
tau_syn.E = gen_param(15/2,0,n,0); % Excitatory synaptic time constant 
tau_syn.I = gen_param(15/2,0,n,0); % Inhibitory synaptic time constant
...
tau_phi = gen_param(100/2,0,n,1); % ms
